% Create submission for Part 3 of the MATLAB simulator
function [] = create_submission_3()
    % The lab handin directory.
    currentDir = fileparts(mfilename('fullpath'));
    outputFile = fullfile(currentDir, 'handin-p3.tar.gz');
    ...
    filesEL = dir(fullfile(strcat(currentDir, '/EulerLagrange'), '*.m'));
    
    files = [files; filesRot; filesPlanar; files3D; filesVec; filesJacobian; filesEL];
